...
describe('BinarySearch', () => {
  ...
  describe('searchRecursive', () => {
    test('should return correct index when target is found in the array', () => {
      const arr = [5, 8, 9, 12, 15];
      expect(binarySearch.searchRecursive(arr, 12)).toEqual(3);
      expect(binarySearch.searchRecursive(arr, 5)).toEqual(0);
      expect(binarySearch.searchRecursive(arr, 15)).toEqual(4);
    });

    test('should return -1 when target is not found in the array', () => {
      const arr = [5, 8, 9, 12, 15];
      expect(binarySearch.searchRecursive(arr, 10)).toEqual(-1);
      expect(binarySearch.searchRecursive(arr, 1)).toEqual(-1);
      expect(binarySearch.searchRecursive(arr, 20)).toEqual(-1);
    });
    ...
    test('should return correct index when the array has one element and it is the target', () => {
      const arr = [7];
      expect(binarySearch.searchRecursive(arr, 7)).toEqual(0);
    });
